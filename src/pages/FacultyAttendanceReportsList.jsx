...
const FacultyAttendanceReportsList = () => {
  ...
  const fetchMySections = async () => {
    try {
      ...
      console.log('✅ Faculty sections loaded for reports:', sectionsData.length);
    } catch (error) {
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Ders section'larınız için yoklama raporlarını görüntüleyin
          </p>
        </motion.div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="p-3 bg-slate-50 dark:bg-slate-800 rounded-lg">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <p className="text-xs text-slate-600 dark:text-slate-400">Rapor</p>
                      </div>
                      <p className="text-2xl font-bold text-slate-900 dark:text-white">
                        Hazır
                      </p>
...
export default FacultyAttendanceReportsList;
